...
import cn.pjt.base.net.utils.ResourceTools;
...
public class HttpCreator {
    ...
    private static final class OKHttpHolder {
        ...
        private static final ArrayList<Interceptor> INTERCEPTORS = PNetHelper.getConfiguration(ConfigKeys.INTERCEPTOR);
    ...
    private static final class RetrofitHolder {
        private static final String BASE_URL = PNetHelper.getConfiguration(ConfigKeys.API_HOST);
...
//              .addConverterFactory(ScalarsConverterFactory.create())
    ...
    private static InputStream trustedCertificatesInputStream() {
        String cer = PNetHelper.getConfiguration(ConfigKeys.HTTPS_CER);
        String comodoRsaCertificationAuthority = ResourceTools.readAssets2String(PNetHelper.getApp(), cer);
        return new Buffer()
